...
本项目提供全面的 **GPT-4o 国内使用指南**，包括国内可用的 [**GPT-4o 中文版**](https://chat.lanjing.pro)、[**GPT-4o 国内入口**](https://xsimplechat.com) 推荐和详细使用教程，帮助您快速使用上 GPT-4o 文生图、图生图~
...
1. **选择镜像网站**：访问推荐的镜像站点（如 **蓝鲸AI ([chat.lanjing.pro](https://chat.lanjing.pro))**）。
